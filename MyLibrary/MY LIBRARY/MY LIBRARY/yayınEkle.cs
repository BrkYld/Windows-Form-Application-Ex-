...
{
    public partial class yayınEkle : Form
    {
        ...
        {
            baglanti.Open();
            sorgu = new SqlCommand("insert into YayınEvi(yayınEvi) values (@yayınAd)", baglanti);
            sorgu.Parameters.AddWithValue("@yayınAd", textBox1.Text);
